...
{name: "Small Hail", valence: 0.32},{name: "Light Freezing Drizzle", valence: 0.33},{name: "Light Freezing Fog", valence: 0.34},{name: "Light Blowing Snow", valence: 0.35},{name:"Rain", valence: 0.38},{name: "Heavy Rain", valence: 0.375},
{name: "Heavy Rain Showers", valence: 0.39},{name: "Heavy Rain Mist", valence: 0.405},{name: "Heavy Mist", valence: 0.42}, {name: "Heavy Fog", valence: 0.435},{name: "Heavy Fog Patches", valence: 0.45},{name: "Heavy Drizzle", valence: 0.465},
{name: "Light Rain", valence: 0.48},{name: "Light Drizzle", valence: 0.495},{name:"Snow", valence:0.50},{name: "Heavy Snow", valence: 0.51},{name: "Heavy Snow Showers", valence: 0.525},{name: "Light Rain Mist", valence: 0.54},{name: "Light Rain Showers", valence: 0.555},{name: "Light Snow Showers", valence: 0.57},
...
(function() {
  ...
  //  Button clicks
    ...
    var obtainWeather =  function(){
      ...
      $.ajax({
        type: "GET",
        url: "https://api.wunderground.com/api/"+ process.env.WU_KEY +"/conditions/q/"+ user_state+"/"+user_city+".json",
        dataType: "json",
      ...
      $.ajax({
        ...
        success: function(playlist){
          ...
          $.ajax({
            ...
            dataType: "json",
            data: "{\"name\":\"" + user_city + "- " + weather_data.current_temp + " degrees and " + weather_data.current_conditions+ ": A Weather Radio Playlist\", \"public\":true}",
